insert into _User (user_id, username, password, role) VALUES ('1', 'trainer', 'pw', 'TRAINER');
insert into _User (user_id, username, password, role) VALUES ('2', 'customer', 'pw', 'CUSTOMER');
