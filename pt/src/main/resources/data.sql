insert into _User (user_id, username, password, role) VALUES ('11', 'user', 'password', 'TRAINER');
insert into _User (user_id, username, password, role) VALUES ('22', 'customer', 'pw', 'CUSTOMER');
